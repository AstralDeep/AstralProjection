        ...
        fun fromJson(value: JsonObject): LocalVoiceFrame? {
            ...
            val disposition =
                when (type) {
                    ...
                    "voice_local_playout_event" -> if (value.string("phase") in setOf("started", "finished", "interrupted", "failed") && (value["reason"] == null || value.string("reason") in reasons)) LocalVoiceDisposition.FINISHED else return null
                    else -> return null
                }
