// Tests for the web topbar (shared renderer/CSS plus the canvas visibility reducer):
// control-cluster layout and wrapping under synthetic authenticated-context flags, not live IAM.
