// Tests for watch workspace presentation: commit-fence release on correlated terminal outcomes only,
// admission-refusal scoping, replay protection across new chats, and ephemeral-welcome acceptance on
// registration.
