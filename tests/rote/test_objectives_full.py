"""Tests for backend/rote/objectives.py: the multi-objective scorers (width_fit,
interaction_cost, glanceability, speakability) stay in [0,1], weighted aggregation
responds to custom weights, and best_adaptation picks and tie-breaks candidates.
"""
