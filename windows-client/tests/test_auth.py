"""Tests for astral_client/app.py and auth.py: desktop OIDC helpers — PKCE encoding,
silent refresh, the auth-resolution policy (explicit token wins; no authority means
dev-token), and the cancellable loopback wait for window-first launch.
"""
