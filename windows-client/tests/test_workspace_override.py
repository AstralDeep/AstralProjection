"""Tests for windows-client workspace override (win_agent/tools.py,
astral_client/app.py): a runtime folder override confines file/tool writes, and
MainWindow's lazy first-use picker resolves and persists it.
"""
