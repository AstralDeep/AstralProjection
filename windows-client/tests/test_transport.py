"""Tests for astral_client/protocol.py: desktop transport backoff/cap, the bounded
offline send queue with FIFO drop-oldest overflow, replay-preparation rejection
requeuing, and delivery during the connect-window race.
"""
